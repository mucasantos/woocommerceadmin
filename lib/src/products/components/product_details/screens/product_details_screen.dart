...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  //       productReviewsWidget = _getExpansionTile(
  //         "Reviews",
  ...
  //           if (productData.containsKey("reviews_allowed") &&
  //               productData["reviews_allowed"] is bool) {
  //             reviewsAllowed = productData["reviews_allowed"];
  //           }
  //           String result = await Navigator.push(
  //             context,
  //             MaterialPageRoute(
  //               builder: (context) => EditProductReviewsPage(
  //                 baseurl: widget.baseurl,
  //                 username: widget.username,
  //                 password: widget.password,
  //                 id: widget.id,
  ...
  //       productCategoriesWidget = _getExpansionTile(
  //         "Categories",
  //         productCategoriesWidgetData,
  //         isTappable: true,
  //         onTap: () async {
  //           List selectedProductCategories = [];
  //           if (isProductDataReady &&
  //               productData.containsKey("categories") &&
  //               productData["categories"] is List &&
  //               productData["categories"].isNotEmpty) {
  //             selectedProductCategories = productData["categories"];
  //           }

  //           String result = await Navigator.push(
  //             context,
  //             MaterialPageRoute(
  //               builder: (context) => EditProductCategoriesPage(
  //                 baseurl: widget.baseurl,
  //                 username: widget.username,
  //                 password: widget.password,
  //                 id: widget.id,
